pipeline {
    ...
    environment {
        AWS_ACCESS_KEY_ID = credentials('rawabi-aws-secret-key-id') 
        AWS_SECRET_ACCESS_KEY = credentials('Rawabi-aws-secret-access-key')

        AWS_S3_BUCKET = "rawabi-belt2d2-artifacts-123456"
